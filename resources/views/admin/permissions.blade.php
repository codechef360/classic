        ...
        <form class="needs-validation" novalidate action="{{route('permissions')}}" method="post">
            ...
            <div class="form-row">
                <div class="col-md-12 mb-4">
                    <label for="validationCustom03">Permission Name</label>
                    <input type="text" class="form-control" value="{{old('permission_name')}}" name="permission_name"  placeholder="Permission Name" required>
                    <div class="invalid-feedback">
                        Please a unique permission name
                    </div>
