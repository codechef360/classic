...
@section('title')
    {{$customer->company_name  ?? $customer->first_name  }}'s Profile
@endsection
@section('page-name')
    {{$customer->company_name  ?? $customer->first_name  }}'s Profile
@endsection
        ...
        <div class="user-profile layout-spacing">
            <div class="widget-content widget-content-area">
                ...
                <div class="text-center user-info">
                    ...
                    <p class="">{{$customer->first_name ?? ''}} {{$customer->surname ?? ''}}</p>
                </div>
                <div class="user-info-list">
                    ...
                    <div class="">
                        <ul class="contacts-block list-unstyled">
                            ...
                            <li class="contacts-block__item">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-phone"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"></path></svg> {{$customer->phone_no ?? ''}}
                            </li>
                            <li class="contacts-block__item">
                    ...
                    <div class="widget-header">
                        <div class="row">
                            <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                <h4>{{$customer->company_name  ?? $customer->first_name  }}'s Statistics</h4>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                        <div class="widget widget-one_hybrid widget-referral">
                                            <div class="widget-heading">
                                                ...
                                                <p class="w-value">{{count($customer->getCustomerAdverts)}}</p>
                                                <h5 class="">Adverts</h5>
                                            </div>
                                            <div class="widget-content">
                                                <div class="w-chart">
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                        <div class="widget widget-one_hybrid widget-engagement">
                                            <div class="widget-heading">
                                                ...
                                                <p class="w-value">{{number_format($customer->getCustomerAdverts->sum('price'))}}</p>
                                                <h5 class="">Revenue</h5>
                                            </div>
                                            <div class="widget-content">
                                                <div class="w-chart">
                                    ...
                                    <div class="col-md-12 col-lg-12">
                                        <div class="table-responsive mb-4 mt-4">
                                            ...
                                            <table id="multi-column-ordering" class="table table-hover" style="width:100%">
                                                ...
                                                @endphp
                                                <tbody>
                                                @foreach($customer->getCustomerAdverts as $advert)
                                                    <tr>
                                                        <td>{{$serial++}}</td>
                                                        <td>{{$advert->title ?? ''}}</td>
