...
<div class="col-xl-3 col-lg-3 col-sm-3  layout-spacing">
    <div class="widget-content widget-content-area br-6">
        <form class="needs-validation" novalidate action="{{route('donzy.areas')}}" method="post" autocomplete="off">
            @csrf
            <div class="form-row">
                <div class="col-md-12 mb-4">
                    <label for="validationCustom03">Areas Name</label>
                    <input type="text" class="form-control" value="{{old('area_name')}}" name="area_name"  placeholder="Area Name" required>
                    <div class="invalid-feedback">
                        Please a unique area name
                    </div>
                    @error('area_name')
        ...
        <div class="table-responsive mb-4 mt-4">
            ...
            <table id="multi-column-ordering" class="table table-hover" style="width:100%">
                ...
                @foreach ($areas as $area)
                        <tr>
                            <td>{{$serial++}}</td>
                            <td>{{$area->getLocation->location_name ?? ''}}</td>
