...
<div class="col-xl-3 col-lg-3 col-sm-3  layout-spacing">
    <div class="widget-content widget-content-area br-6">
        <form class="needs-validation" novalidate action="{{route('donzy.locations')}}" method="post" autocomplete="off">
            @csrf
            <div class="form-row">
                <div class="col-md-12 mb-4">
                    <label for="validationCustom03">Location Name</label>
                    <input type="text" class="form-control" value="{{old('location_name')}}" name="location_name"  placeholder="Location Name" required>
                    <div class="invalid-feedback">
                        Please a unique location name
                    </div>
                    @error('location_name')
